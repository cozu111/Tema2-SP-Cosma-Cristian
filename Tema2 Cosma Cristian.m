%Cosma Ioan Cristian  grupa 424D

%Numarul de ordine 11,impar=>dreptunghiular
...
N=50; 
f=1/P; 
w0=2*pi*f; %frecventa unghiulara/pulsatia 
...
perioada=P/rez; %numarul esantioanelor intr-o perioada
inter1=0:rez:P;
...
semnal=repmat(s1,1,5);% se repeta semnalul initial de 5 ori
figure
plot(semnal)
